...
export class CustomerComponentComponent implements OnInit {
  ...
  registrationForm = new FormGroup({
    ...
    customerName: new FormControl('', [Validators.required, Validators.minLength(6), Validators.pattern('^[a-zA-Z_.-]{2,}(?: [a-zA-Z]+)?(?: [a-zA-Z]+)?$')] ),

    fatherName: new FormControl('', [Validators.required, Validators.minLength(6), Validators.pattern('^[a-zA-Z_.-]{2,}(?: [a-zA-Z]+)?(?: [a-zA-Z]+)?$')]),
